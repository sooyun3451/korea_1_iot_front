...
//# 반복문의 종류
// : for반복문, while반복문, do-while반복문(for...in 반복문, for...of 반복문)

// +) 배열(Array)
// : 여러개의 변수를 한 번에 선언하여 다룰 수 있는 자료형(참조 자료형) 
...
// 행에 대한 반복 : 5번실행
console.log('=== 별찍기 ===');
for (let i = 1; i < 6; i++) { // 1부터 5까지 5번 실행
  let stars = '';
...
*/
console.log('===별찍기2 ===');
for(let i = 5; i > 0; i--) { // 행에 대한 반복 5,4,3,2,1
  let stars = '';
  for(let j = 0; j < i; j++) { //별에 대한 반복 54321
    //첫번째 행 (i 가 5) >> 0,1,2,3,4
    //두번째 행 (i 가 4) >> 0,1,2,3
    //세번째 행 (i 가 3) >> 0,1,2
    // ...
    stars += '*';
 ...
 ****
*****
  행이 시작 시 공백이 부여 문자열 안에 ''
  각 행의 자리마다 그 개수의 별이 찍힘 
*/
