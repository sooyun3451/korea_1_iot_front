...
// >> 코드가 순차적으로 실행되다기 오류가 위치하는 부분 이후에 실행이 중단

// EX) 파일을 찾을 수 X, 입력이 잘못 이루어진 경우, 네트워크 연결 오류 등
console.log('=== 런타임 오류 예제 ===');
// console.rog('log를 rog로 잘못 입력했습니다'); - Error
