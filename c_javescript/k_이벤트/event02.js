...
function bgChange(event) {
  ...
  // event.target: HTML요소(JS DOM 요소 - 객체)
...
// === 이벤트 객체 실습 === 
// 16개의 타일 시트
// quarySelectorAll() 사용 >> 16개의 참조를 tiles 상수에 할당
...
//! 2. 이벤트의 기본 행동 방지
// form 태그의 경우 submit 버튼 실행시, 내부의 데이터가 서버에 전송되고 페이지가 리로드
