...
document.addEventListener('DOMContentLoaded', () => {
  ...
  a.textContent = '<h2>text Content 속성</h2>';
  // : 텍스트 그 자체가 내용으로 삽입

  b.innerHTML = '<h2>text Content 속성</h2>';
  // : HTML문서구조를 인식하고 해석한 뒤 내용만 삽입
});
...
// >> 내장된 속성들은 .(온점)연산자를 사용하여 속성 읽기 또는 지정이 가능
document.addEventListener('DOMContentLoaded', () => {
...
//# 3) 스타일 조작하기
// : 문서객체의 스타일 조작시 style 속성을 사용

//? style속성은 JS에서 객체로 인식
// : JS 문법 체계에서는 식별자에 -(하이픈) 기호 사용 X
// >> lowerCamelCase 사용을 권장
// text-aline >> textAlign
// font-size >> fontSize
