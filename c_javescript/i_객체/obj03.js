...
//    : 모든 객체들이 메서드와 속성을 상속받기 위한 템플릿(틀)으로써 프로토타임 객체를 가짐
...
let person1 = new Person('길동', '홍', 50, 'female');
...
let human1 = new Human('홍길동', 20, '학생');
let human2 = new Human('홍길서', 28, '직장인');

human1.greet(); // 안녕하세요 홍길동님
human2.greet(); // 안녕하세요 홍길서님
