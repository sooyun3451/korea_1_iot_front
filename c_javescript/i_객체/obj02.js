...
let dog = {
  ...
  color : 'white',
  favoriteToy : ['곰인형', '탱탱볼'],
  bark : function() { // bark: 짓다
    console.log('멍멍');
  },
  greet : function() {
    // 해당 객체가 가진 속성에 접근을 하는 경우 'this'사용
...
// let result = dog.greet(); return이 있으면 이렇게 담아주면 됨
