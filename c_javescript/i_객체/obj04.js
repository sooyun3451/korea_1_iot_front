...
//? 복사된 객체의 값을 변경
animal2.name = '초코';
animal2.owner.name = '홍길서';

//? 원본 객체를 출력
console.log(animal1.name); // 초코
console.log(animal1.owner.name); // 홍길서

console.log(animal2); // { name: '초코', owner: { name: '홍길서', job: 'Developer' } }
...
//# 객체의 속성 확인 연산자
// { title: '어린왕자', author: '생택쥐페리', publishYear: 2024 } - 기준으로
