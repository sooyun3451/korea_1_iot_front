...
// : 배열의 매서드로 반환되는 값은 자동으로 배열 내에 저장
...
// 1. 전체 배열의 요소를 순화하여 출력 - forEach(콘솔 출력)
...
// >> 문자열데이터.length
console.log('=== filter예제 ===');

let carsLength = cars.filter(car => car.length > 4);

console.log(carsLength); // [ 'volvo', 'hyundai' ]
