...
console.log(result1); // 사과,바나나,망고
console.log(result2); // 사과 바나나 망고
console.log(result3); // 사과-바나나-망고
...
console.log(result4); // [ '사과', '바나나', '망고' ]
console.log(result5); // [ '사과', '바나나', '망고' ]
console.log(result6); // [ '사과', '바나나', '망고' ]
