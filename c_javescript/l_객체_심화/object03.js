...
console.log(now.getSeconds()); //53

//? 현지 날짜 표기법 & 시간 표기법
console.log(now.toLocaleDateString()); //2024. 8. 8.
console.log(now.toLocaleTimeString()); //오전 11:48:59