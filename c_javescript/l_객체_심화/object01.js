...
console.log(notNum === NaN); //false: NaN 데이터는 비교연산자로 사용이 불가
...
console.log('=== trim() ==='); // input에 value에 사용하는것이 효율적
...
console.log(manyData); //[ '생년,월,일', '1999,01,01', '2000,02,02', '2001,03,03', '2002,04,04' ]

// 배열 내부의 문자열을 ,(콤마)를 기준으로 나누기
...
//& 3) length
// : 문자열 길이를 반환
// >> 띄어쓰기,줄바꿈도 하나의 문자열로 인식
let stringC = ' hello, JS ^^'; //13
