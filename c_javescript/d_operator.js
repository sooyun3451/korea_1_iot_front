...
console.log(x - y); // 7
console.log(x * y); // 30
console.log(x / y); // 33.3333
console.log(x % y); // 1 (나머지 a % b - a를 b로 나누고 난 나머지)
console.log(10 % 2); // 0

// +) 증감 연산자
// : ++, --의 형태로 수를 1씩 증가 또는 감소시킬 떄 사용하는 연산자
// : 1항(하나의 데이터)에 대한 연산식
...
// : 데이터의 앞에 연산자가 있을 경우 전위(바로 값을 변환!)
...
// , 결과를 참(true)과 거짓(flase)로 반환 >> boolean 타입
