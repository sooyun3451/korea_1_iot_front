...
//? 해당 DOM 요소가 존재하면 input태그의 값(value)를 존재하지 않을 경우 빈 문자열을 반환
// >> 조건문
...
fetchButton === null || fetchButton === void 0 ? void 0 : fetchButton.addEventListener('click', function () { return __awaiter(void 0, void 0, void 0, function () {
    var userDataDiv, userIdElement, userId, apiUrl, response, user, error_1, errorMsg;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                userDataDiv.textContent = "<p>Loading user data</p>";
                _a.label = 1;
            case 1:
                _a.trys.push([1, 4, , 5]);
            ...
            case 4:
                error_1 = _a.sent();
                userDataDiv.textContent = "<p>".concat(error_1, "</p>");
