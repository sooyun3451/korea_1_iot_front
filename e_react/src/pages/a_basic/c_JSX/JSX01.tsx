...
/*
! JSX(TSX)
: JS(TS 파일 내에서 HTML과 유사한 마트업을 작성할 수 있도록 해주는 JS 구문 확장 문법
...
: JSX 내에서 Babel 사용해 JS로 변환하려면 XML 문법을 준수
...
export default function JSX01() {
  ...
  return (
    ...
    */}
    <button onClick={() => {handleClick('Click')}}>클릭해 주세요</button>
